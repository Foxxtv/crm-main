...
export const handleProspectsAPI = async (request: Request, url: URL): Promise<Response> => {
...
const getProspects = async (userId: string, searchParams: URLSearchParams): Promise<Response> => {
...
const getProspect = async (userId: string, prospectId: string): Promise<Response> => {
...
const createProspect = async (userId: string, request: Request): Promise<Response> => {
...
const updateProspect = async (userId: string, prospectId: string, request: Request): Promise<Response> => {
  const body = await request.json();
...
const deleteProspect = async (userId: string, prospectId: string): Promise<Response> => {
