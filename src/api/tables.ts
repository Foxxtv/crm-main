...
export const handleTablesAPI = async (request: Request, url: URL): Promise<Response> => {
...
const getTableRecords = async (tableName: string, userId: string, searchParams: URLSearchParams): Promise<Response> => {
...
const getTableRecord = async (tableName: string, recordId: string, userId: string): Promise<Response> => {
...
const createTableRecord = async (tableName: string, schema: any, userId: string, request: Request): Promise<Response> => {
...
const updateTableRecord = async (tableName: string, recordId: string, schema: any, userId: string, request: Request): Promise<Response> => {
  const body = await request.json();
...
const deleteTableRecord = async (tableName: string, recordId: string, userId: string): Promise<Response> => {
